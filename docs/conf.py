...
html_logo = "_static/gsdc-logo.png"
...
man_pages = [
    (master_doc, 'tem-docs', u'tem-docs Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'tem-docs', u'tem-docs Documentation',
     author, 'tem-docs', 'One line description of project.',
     'Miscellaneous'),
]
