...
1. Find out relion applications module path by `module keyword` command
    ...
    Here, you can find relion-related module paths (e.g., **apps/relion/5.0.0/cpu/intel-compiler-2024.0.2**, where the module is the relion version 5.0.0 applcation built upon using intel compiler).
