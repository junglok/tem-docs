...
| Server Name            | Specification                                                           | Remarks               |
| ---------------------- | ----------------------------------------------------------------------- | --------------------- |
| tem-dm-al9.sdfarm.kr   | Intel Xeon 3.1GHz 18Core * 2CPUs, 384GB Memory                          | Globus Online (GridFTP)|
| tem-dtn-al9.sdfarm.kr  | Intel Xeon 2.7GHz 18Core * 2CPUs, 384GB Memory                          | Rclone, GridFTP        |
