...
???+ tip "More detailed information about `qpuQ`"
    ...
    **Assigned Computing Resources**
    ...
    > * tem-gpu[13-13]-al9.sdfarm.kr : Intel® Xeon® Gold 6334R CPU@3.60GHz 32 Cores, 384GB Memory, NVIDIA V100 32GB * 4EA  (Logically A100 40GB * 8EA using MIG)

    
    **Remarks** : Total 300 CPU cores, 26 NVIDIA GPUs (MIG GPU Instances : 42 GPUs Total)
